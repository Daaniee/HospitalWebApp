...
{
    /// <inheritdoc />
    public partial class FixPermissionModel : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CustomId = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    FullName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AvailableDoctors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AvailableDoctors_Staff_DoctorId",
                        column: x => x.DoctorId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MedicalRecords_Staff_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Staff",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "RegisterPatient", null },
                    { 2, "EditPatientInfo", null },
                    { 3, "ViewPatients", null },
                    { 4, "ScheduleAppointment", null },
                    { 5, "AssignDoctor", null },
                    { 6, "EditMedicalRecord", null },
                    { 7, "ViewMedicalRecord", null },
                    { 8, "Diagnose", null },
                    { 9, "PrescribeMedication", null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AvailableDoctors_DoctorId",
                table: "AvailableDoctors",
                column: "DoctorId");
